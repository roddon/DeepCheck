    ...
    <div class="header_cn">
        ...
        <div class="header_right">
            ...
            <div class="hd_notification">
                <div class="noti_num">2</div>
                <a href="#"><img src="{{ asset('assets/images/notification.png') }}" alt=""></a>
            </div>
            <div class="hd_contact">
                <div class="noti_num">{{ isset($unreadEmail) ? $unreadEmail : 0 }}</div>
                <a href="{{ route('email.index') }}"><img src="{{ asset('assets/images/contact.png') }}" alt=""></a>
            </div>
            <div class="hd_profile">
                <a href="#" class="acout_drop_down">
                    <div class="profile_cn">
                        <div class="profile_img">
                            <!-- <img src="{{ asset('assets/images/Bitmap.png') }}" alt=""> -->
                        </div>

...
<div class="row mb-2">
    ...
    <div class="col-md-6 text-right">
        ...
        <div class="invitebtnarae ml-3 float-right">
            <a href="{{ route('admin.members.create') }}" class="invite" id="add-new-user">Add new member</a>
        </div>
            ...
            <table class="table tablefst  table-hover ">
                <thead>
                    <tr>
                        ...
                        <th class="border-right-0">Account Number</th>
                        <th class="border-right-0">Company Name</th>

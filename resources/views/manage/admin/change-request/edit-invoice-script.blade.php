<script>
    ...
    $('.edit-line-item').click(function() {
        ...
        $.ajax({
            url: "{{route('admin.change-request.update-invoice-media-items')}}",
            type: 'POST',
            data: items,
    ...
    updateInvoiceMedia = function(requestData) {
        $.ajax({
            url: "{{route('admin.change-request.updateInvoiceMedia')}}",
            type: 'POST',
            data: requestData,
            success: function(result) {
                $('#overlay').fadeOut();
    ...
    $('.approvedChanges').click(function(){
        mediaId = $('input[name=mediaId]').val();
        updateInvoiceMediaStatus({
            reviewStatus:1,
            mediaId:mediaId
        });
    });

    $('.rejectedChanges').click(function(){
        mediaId = $('input[name=mediaId]').val();
        updateInvoiceMediaStatus({
            reviewStatus:2,
            mediaId:mediaId
    ...
    updateInvoiceMediaStatus = function(requestData) {
        $.ajax({
            url: "{{route('admin.change-request.updateInvoiceMediaStatus')}}",
            type: 'POST',
            data: requestData,
            success: function(result) {
                $('#overlay').fadeOut();

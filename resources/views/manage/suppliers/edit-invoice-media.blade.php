                ...
                <div class="col-md-4 pl-md-0">
                    <div class="edit-detail-wrapper affix">
                        ...
                        <form class="invoice-edit-form pl-md-4">
                            ...
                            @if(is_null($isAdminReview))
                                <a href="javascript:void(0);" class="invite mt-md-5 mt-3 review sendToAdmin col-md-12 text-center">SEND FOR ADMIN REVIEW</a>
                            @endif
                        </form>
                    </div>
                </div>
...
@section('scripts')
@include('manage.suppliers.edit-invoice-media-script')
@endsection